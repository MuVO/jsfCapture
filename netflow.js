...
exports.parse = function(buffer){
	...
	sys_uptime: buffer.readUInt32BE(4),
	unix_secs: buffer.readUInt32BE(8),
	unix_nsecs: buffer.readUInt32BE(12),
	flow_sequence: buffer.readUInt32BE(16),
	engine_type: buffer.readUInt8(20),
	engine_id: buffer.readUInt8(21),
	sampling_interval: buffer.readUInt16BE(22),
	recs: nfRecs(buffer.slice(24),buffer.readUInt16BE(2)),
    };
}
